...
Samples und beim erneuten Generieren nicht überschrieben.
...
Konfigurations-Optionen zum Generieren der OIDs, siehe build_gme_and_oid.bat:
  -S NUM_START_OID, --num-start-oid=NUM_START_OID
                        For -t/--build-oid-table: Generate N START OIDs (e.g.
                        to re-use the same product id for multiple projects).
